...
namespace Crimson
{
    ...
    public class PixelText : GraphicsComponent
    {
        ...
        public PixelText(PixelFont font, float fontSize, string text, Vector2 position, Color color,
        ...
        public PixelText(PixelFont font, float fontSize, string text, Vector2 position,
            HorizontalAlign horizontalAlign = HorizontalAlign.Center,
            VerticalAlign verticalAlign = VerticalAlign.Center)
