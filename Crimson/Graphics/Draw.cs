...
namespace Crimson
{
    public static class Draw
    {
        ...
        {
            SpriteBatch.DrawString(font, text, Mathf.Floor(position), color);
        }
        ...
        {
            SpriteBatch.DrawString(font, text, Mathf.Floor(position), color, rotation, origin, scale, SpriteEffects.None,
                0);
        }
        ...
        public static void TextJustified(SpriteFont font, string text, Vector2 position, Color color, Vector2 justify)
        {
            ...
            SpriteBatch.DrawString(font, text, Mathf.Floor(position), color, 0, origin, 1, SpriteEffects.None, 0);
        }
        ...
        )
        {
            ...
            origin.X *= justify.X;
            origin.Y *= justify.Y;
            SpriteBatch.DrawString(font, text, Mathf.Floor(position), color, 0, origin, scale, SpriteEffects.None, 0);
        }
        ...
        public static void OutlineTextCentered(SpriteFont font, string text, Vector2 position, Color color, float scale)
        {
            ...
            for (var j = -1; j < 2; j++)
                if (i != 0 || j != 0)
                    SpriteBatch.DrawString(font, text, Mathf.Floor(position) + new Vector2(i, j), Color.Black, 0, origin,
        ...
        )
        {
            ...
            for (var j = -1; j < 2; j++)
                if (i != 0 || j != 0)
                    SpriteBatch.DrawString(font, text, Mathf.Floor(position) + new Vector2(i, j), outlineColor, 0,
