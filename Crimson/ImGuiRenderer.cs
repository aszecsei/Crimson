...
namespace Crimson
{
    ...
    public class ImGuiRenderer
    {
        ...
        private readonly List<(ImGuiKey ImGuiKey, Keys XnaKey)> _keys = new List<(ImGuiKey, Keys XnaKey)>();
        ...
        public ImGuiRenderer()
        {
            ...
            _graphicsDevice = Engine.Instance.GraphicsDevice;
        ...
        protected virtual void SetupInput()
        {
            ...
            // MonoGame-specific //////////////////////
            Engine.Instance.Window.TextInput += (s, a) =>
            {
        ...
        protected virtual Effect UpdateEffect(Texture2D texture)
        {
            ...
            _effect.Projection =
                Matrix.CreateOrthographicOffCenter(offset, io.DisplaySize.X + offset, io.DisplaySize.Y + offset, offset,
                    -1f, 1f);
