...
namespace Crimson
{
    public struct Particle
    {
        ...
        public bool SimulateFor(float duration)
        {
            ...
            var dt = Time.TimeRate * (Engine.Instance.TargetElapsedTime.Milliseconds / 1000f);
            if (dt > 0)
        ...
        public void Update(float? delta = null)
        {
            ...
            if (delta.HasValue)
                ...
                dt = Type.UseActualDeltaTime ? Time.RawDeltaTime : Time.DeltaTime;
            ...
            else
            {
                if (Type.ColorMode == ParticleType.ColorModes.Static)
                    ...
                    Color = Mathf.BetweenInterval(Life, .1f) ? StartColor : Type.Color2;
