...
namespace Crimson
{
    ...
    public class AutotileData
    {
        ...
        {
            Center = Utils.ReadCSVInt(xml.ChildText("Center", ""));
            Single = Utils.ReadCSVInt(xml.ChildText("Single", ""));

            SingleHorizontalLeft = Utils.ReadCSVInt(xml.ChildText("SingleHorizontalLeft", ""));
            SingleHorizontalCenter = Utils.ReadCSVInt(xml.ChildText("SingleHorizontalCenter", ""));
            SingleHorizontalRight = Utils.ReadCSVInt(xml.ChildText("SingleHorizontalRight", ""));

            SingleVerticalTop = Utils.ReadCSVInt(xml.ChildText("SingleVerticalTop", ""));
            SingleVerticalCenter = Utils.ReadCSVInt(xml.ChildText("SingleVerticalCenter", ""));
            SingleVerticalBottom = Utils.ReadCSVInt(xml.ChildText("SingleVerticalBottom", ""));

            Top = Utils.ReadCSVInt(xml.ChildText("Top", ""));
            Bottom = Utils.ReadCSVInt(xml.ChildText("Bottom", ""));
            Left = Utils.ReadCSVInt(xml.ChildText("Left", ""));
            Right = Utils.ReadCSVInt(xml.ChildText("Right", ""));

            TopLeft = Utils.ReadCSVInt(xml.ChildText("TopLeft", ""));
            TopRight = Utils.ReadCSVInt(xml.ChildText("TopRight", ""));
            BottomLeft = Utils.ReadCSVInt(xml.ChildText("BottomLeft", ""));
            BottomRight = Utils.ReadCSVInt(xml.ChildText("BottomRight", ""));

            InsideTopLeft = Utils.ReadCSVInt(xml.ChildText("InsideTopLeft", ""));
            InsideTopRight = Utils.ReadCSVInt(xml.ChildText("InsideTopRight", ""));
            InsideBottomLeft = Utils.ReadCSVInt(xml.ChildText("InsideBottomLeft", ""));
            InsideBottomRight = Utils.ReadCSVInt(xml.ChildText("InsideBottomRight", ""));
        }
        ...
        private int GetTileID(int[] choices)
        {
            if ( choices.Length == 0 )
                ...
                return Utils.Random.Choose(choices);
        }
    }
}
